...
export enum TbaiErrorCodes {
    ...
    ERR_VF_MISSING_REPLACED_TICKETS = 561116,
    ERR_VF_CREDIT_NOTE_MISSING_BASE_VAT = 561118,
    ERR_VF_RECIPIENT_VAT_NUMBER = 561123,
    ERR_VF_INVALID_TAX_RATE = 561124,
    ERR_VF_OP_DATE_GREATER_THAN_ALLOWED = 561125,
    ERR_VF_COUNTRY_CODE_ES = 561126,
    ERR_VF_INVALID_SURCHARGE_TAX_RATE = 561127,
    ERR_VF_INVOICE_NUMBER_INVALID_CHARACTERS = 561130,
    ERR_VF_ISSUED_TIME_20_YEARS = 561133,
    ERR_VF_OP_DATE_20_YEARS = 561134,
    ERR_VF_10_EURO_EXCEEDED_AMOUNT_LINES = 561142,
    ERR_VF_INCORRECT_BASE_AMOUNT_SING = 561143,
    ERR_VF_OP_DATE_NO_AFTER_ISSUE = 561146,
    ERR_VF_SIMPLE_EXCEEDED = 561150,
    ERR_VF_ISSUED_TIME_INCORRECT = 561152,
    ERR_VF_INVALID_TYPE_FOR_ID_TYPE_02 = 561156,
    ERR_VF_MISSING_RECIPIENT_FOR_THIRD_PARTY = 561158,
    ERR_VF_INCOMPATIBLE_SURCHARGE_TAX_RATE = 561160,
    ERR_VF_MISSING_ISSUER_FOR_THIRD_PARTY = 561186,
    ERR_VF_ISSUER_ISSUED_BY_NIF = 561188,
    ERR_VF_MISSING_RECIPIENT = 561189,
    ERR_VF_SIMPLE_NO_RECIPIENT = 561190,
    ERR_VF_ISSUER_RECIPIENT_NIF = 561193,
    ERR_VF_INCORRECT_INVOICE_TYPE_FOR_S2 = 561197,
    ERR_VF_VAT_LINE_S2_INCORRECT_RATES = 561198,
    ERR_VF_VAT_KEY_01_E2_E3 = 561199,
    ERR_VF_INCORRECT_OPERATION_VAT_KEY_03 = 561200,
    ERR_VF_INCORRECT_OPERATION_VAT_KEY_04 = 561201,
    ERR_VF_INCORRECT_OPERATION_VAT_KEY_06 = 561202,
    ERR_VF_INCORRECT_OPERATION_VAT_KEY_07 = 561203,
    ERR_VF_INCORRECT_OPERATION_VAT_KEY_10 = 561205,
    ERR_VF_VAT_LINE_NOT_SUBJECT_INCORRECT_RATES = 561237,
    ERR_VF_MISSING_OPERATION_DATE_VAT_KEY_14 = 561147,
    ERR_VF_INCORRECT_INVOICE_TYPE_VAT_KEY_14 = 561148,
    ERR_VF_RECIPIENT_START_PQSV_VAT_KEY_14 = 561149,
    ERR_VF_INCORRECT_RATE_VAT_KEY_11 = 561206,
    ERR_VF_INVALID_AMOUNT_VAT_OPERATION = 561207,
    ERR_VF_MISSING_AMOUNT = 561208,
    ERR_VF_SUM_VAT_LINES_TOTAL = 561210,
...
export enum TbaiErrorMessages {
    ...
    ERR_VF_RECIPIENT_VAT_NUMBER = "Incorrect VAT number.",
    ERR_VF_INVALID_TAX_RATE = "The value of the field rate is not included in the list of allowed values.",
    ERR_VF_OP_DATE_GREATER_THAN_ALLOWED = "The value of the operationDate field has a higher date than allowed.",
    ERR_VF_COUNTRY_CODE_ES = "The country value can only be ES when the idType is 07 or 03. If idType is 07 the country must be ES.",
    ERR_VF_INVALID_SURCHARGE_TAX_RATE = "The value of the field rate2 is not included in the list of allowed values.",
    ERR_VF_INVOICE_NUMBER_INVALID_CHARACTERS = "Invoice SerialNumber field contains characters not allowed.",
    ERR_VF_ISSUED_TIME_20_YEARS = "The value of the issuedTime field must not be less than the current date minus 20 years.",
    ERR_VF_OP_DATE_20_YEARS = "The value of the operationDate field must not be less than the current date minus 20 years.",
    ERR_VF_10_EURO_EXCEEDED_AMOUNT_LINES = "The amount has an incorrect value for the value of the fields base and rate supplied. (Amount cannot exceed +-10 euro with respect to the base and rate in some lines)",
    ERR_VF_INCORRECT_BASE_AMOUNT_SING = "The fields base and amount must have the same sign.",
    ERR_VF_OP_DATE_NO_AFTER_ISSUE = "The invoice issuedTime is only allowed to be earlier than the operationDate if the breakdown details are vatKey 14 or 15.",
    ERR_VF_SIMPLE_EXCEEDED = "When invoice type is F2 the sum of base and amount of all detail lines shall not exceed 3.000.",
    ERR_VF_ISSUED_TIME_INCORRECT = "The value of the issuedTime is incorrect, it must not be less than 01/07/2024.",
    ERR_VF_INVALID_TYPE_FOR_ID_TYPE_02 = "For recipient block and idType 02, the invoice type is incorrect.",
    ERR_VF_MISSING_RECIPIENT_FOR_THIRD_PARTY = "If issuedBy type is 'D', but the corresponding block is not reported (recipient).",
    ERR_VF_INCOMPATIBLE_SURCHARGE_TAX_RATE = "Incompatible equivalence surcharge tax rate value.",
    ERR_VF_MISSING_ISSUER_FOR_THIRD_PARTY = "If issuedBy type is 'T', but the corresponding block is not reported (issuedBy > issuer).",
    ERR_VF_ISSUER_ISSUED_BY_NIF = "The issuedBy issuer NIF must be different from the invoice issuer.",
    ERR_VF_MISSING_RECIPIENT = "If invoice type is F1 or F3 or R1 or R2 or R3 or R4 the recipients has to be filled in.",
    ERR_VF_SIMPLE_NO_RECIPIENT = "If invoice type is F2 or R5 the recipient cannot be filled in.",
    ERR_VF_ISSUER_RECIPIENT_NIF = "The value of the field irsId is incorrect. The recipient must be different from the issuer.",
    ERR_VF_INCORRECT_INVOICE_TYPE_FOR_S2 = "If vatOperation is S2 invoice type only can be F1, F3, R1, R2, R3 or R4.",
    ERR_VF_VAT_LINE_S2_INCORRECT_RATES = "If vatOperation is S2 rate and amount shall have value 0.",
    ERR_VF_VAT_KEY_01_E2_E3 = "If vatKey is 01, exemption reason cannot be E2 or E3.",
    ERR_VF_INCORRECT_OPERATION_VAT_KEY_03 = "If vatKey is 03 vatOperation can only be S1.",
    ERR_VF_INCORRECT_OPERATION_VAT_KEY_04 = "If vatimeKey is 04 vatOperation can only be S2 or exempted operation.",
    ERR_VF_INCORRECT_OPERATION_VAT_KEY_06 = "If vatkey is 06 not supported.",
    ERR_VF_INCORRECT_OPERATION_VAT_KEY_07 = "If vatKey is 07 vatOperation it cannot be E2, E3, E4, E5, S2, N1 or N2.",
    ERR_VF_INCORRECT_OPERATION_VAT_KEY_10 = "If vatey is 10 vatOperation has to be N1, invoice type F1 and recipiente has to be identified by NIF.",
    ERR_VF_VAT_LINE_NOT_SUBJECT_INCORRECT_RATES = "If vatOperation is N1 or N2 rate must have value 0 and amount, rate2 and amount2 cannot be informed.",
    ERR_VF_MISSING_OPERATION_DATE_VAT_KEY_14 = "If vatKey is 14, OperationDate is mandatory and must be after the issuedTime.",
    ERR_VF_INCORRECT_INVOICE_TYPE_VAT_KEY_14 = "If vatKey is 14, the invoice type field must be F1, R1, R2, R3 or R4.",
    ERR_VF_RECIPIENT_START_PQSV_VAT_KEY_14 = "If vatKey is 14, the recipient must begin with P, Q, S or V.",
    ERR_VF_INCORRECT_RATE_VAT_KEY_11 = "If vatKey is 11 rate must be 21.",
    ERR_VF_INVALID_AMOUNT_VAT_OPERATION = "The amount can only be other than 0 if vatOperation is S1.",
    ERR_VF_MISSING_AMOUNT = "If vatOperation is S1, rate and amount fields are mandatory.",
    ERR_VF_SUM_VAT_LINES_TOTAL = "The total amount of the invoice has an incorrect value for the value of the supplied base, amount and amount2 fields.",
